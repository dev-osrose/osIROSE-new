...
tagGrowAbility  `faction_points3` int(11) unsigned NOT NULL DEFAULT '0',
  ...
  `current_hp` int(10) unsigned NOT NULL DEFAULT '50',
  `current_mp` int(10) unsigned NOT NULL DEFAULT '40',
  `max_hp` int(10) unsigned NOT NULL DEFAULT '50',
  `max_mp` int(10) unsigned NOT NULL DEFAULT '40',
  ...
  `spawn` int(11) NOT NULL DEFAULT '1' COMMENT 'revive map',
...
CREATE TABLE `inventory` (
  ...
  `durability` smallint(7) unsigned NOT NULL DEFAULT '0',
  `life` smallint(10) unsigned NOT NULL DEFAULT '0',
  `has_socket` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `is_appraisal` tinyint(1) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`uid`),
