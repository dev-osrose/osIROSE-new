...
class CCharServer : public CServerSocket
{
	...
	// Community functions
	bool ChangeMessengerStatus( CCharClient* thisclient,
	                            CCharClient* otherclient, int status );
	...
	bool ChangeClanStatus( CCharClient* thisclient, CCharClient* otherclient,
	                       int channel );
