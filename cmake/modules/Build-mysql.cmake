...
if(WIN32)
  ...
  set(MYSQL_LIBRARY "${install_dir}/lib/mysqlclient.lib" CACHE FILEPATH "" FORCE)
  set(MYSQL_LIBRARIES "${install_dir}/lib/mysqlclient.lib" "${MYSQL_LIBRARIES}" CACHE STRING "" FORCE)
else()
  set(MYSQL_LIBRARY_DIR "${install_dir}/lib" CACHE PATH "" FORCE)
  set(MYSQL_LIBRARY_PATH "${MYSQL_LIBRARY_DIR}" CACHE PATH "" FORCE)
