...
ExternalProject_Add(
  ...
  CMAKE_ARGS -G ${CMAKE_GENERATOR} -DCMAKE_BUILD_TYPE=${CMAKE_BUILD_TYPE} -DCMAKE_INSTALL_PREFIX=${SQLPP11_SQLITE3_INSTALL_DIR} -DCMAKE_MODULE_PATH=${CMAKE_MODULE_PATH} -DSQLITE3_INCLUDE_DIR=${SQLITE3_INCLUDE_DIR} -DSQLITE3_LIBRARY=${SQLITE3_LIBRARY} -DSQLPP11_INCLUDE_DIR=${SQLPP11_INCLUDE_DIR} -DENABLE_TESTS=OFF
