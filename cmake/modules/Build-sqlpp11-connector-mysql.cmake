...
if(WIN32)
  ...
  ExternalProject_Add(
    ...
    GIT_REPOSITORY https://github.com/RavenX8/sqlpp11-connector-mysql
    GIT_TAG c6e81fd9ffe8ff63d9d9fba84053aaca20194272
    CMAKE_ARGS -G ${CMAKE_GENERATOR} -DCMAKE_INSTALL_PREFIX=${SQLPP11_MYSQL_INSTALL_DIR} -DCMAKE_MODULE_PATH=${CMAKE_MODULE_PATH} -DSQLPP11_INCLUDE_DIR=${SQLPP11_INCLUDE_DIR} -DDATE_INCLUDE_DIR=${DATE_INCLUDE_DIR} -DENABLE_TESTS=OFF
    BUILD_BYPRODUCTS ${_byproducts}
    DEPENDS SQLPP11::SQLPP11
    INSTALL_DIR ${SQLPP11_MYSQL_INSTALL_DIR}
  )
