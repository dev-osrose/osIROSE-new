...
if(WIN32 AND NOT MINGW)
  ...
  set(BREAKPAD_COMMON_LIBRARY_DIR "${BREAKPAD_EXCEPTION_HANDLER_INSTALL_DIR}/breakpad/client/windows/$<CONFIG>/lib")
  set(BREAKPAD_CRASH_CLIENT_LIBRARY_DIR "${BREAKPAD_EXCEPTION_HANDLER_INSTALL_DIR}/breakpad/client/windows/crash_generation/$<CONFIG>/lib")
  set(BREAKPAD_EXCEPTION_HANDLER_LIBRARY_DIR "${BREAKPAD_EXCEPTION_HANDLER_INSTALL_DIR}/breakpad/client/windows/handler/$<CONFIG>/lib")
