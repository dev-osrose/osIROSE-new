...
if(WIN32)
  ExternalProject_Add(
    ...
    CMAKE_ARGS -DBUILD_SHARED_LIBS=ON -DCMAKE_CXX_FLAGS=${ADD_CXX_FLAGS} -DCMAKE_BUILD_TYPE=${CMAKE_BUILD_TYPE} -Dgtest_force_shared_crt=ON -Dgmock_force_shared_crt=ON
    BUILD_IN_SOURCE 1
    INSTALL_COMMAND ""
  )
else()
