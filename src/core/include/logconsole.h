...
public:
	...
	int incprintf(const char* fmt, ...); // indentated coloured printf -> no identification, but appropriate indent from the left
	int icprintf(const char* fmt, ...); // identified coloured printf -> [ident] sdfhsfh
	int oicprintf(const char* fmt, ...); // omittable identified coloured printf -> [ident] sdfhsfh if debugging
	int eicprintf(const char* fmt, ...); // identified coloured error printf -> [ident] sdfhsfh, but with flashier colours
