...
VISITABLE_STRUCT(Core::Config::ServerData, id, ip, iscListenIp, autoConfigureUrl, parentId, maxConnections, useThreads, autoConfigureAddress, maxThreads, accessLevel, mode);
