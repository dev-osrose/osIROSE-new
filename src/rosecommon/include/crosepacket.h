...
namespace RoseCommon
{
  ...
  class CRosePacket {
  public:
    CRosePacket(ePacketType type, uint16_t CRC = 0, uint8_t reserved = 0) : current_( buffer_ ),
                                                                            size_( 0 ),
                                                                            type_( type ),
                                                                            CRC_( CRC ) {
      (void)reserved;
    ...
    CRosePacket(uint16_t type, uint16_t CRC = 0, uint8_t reserved = 0) : current_( buffer_ ),
                                                                         size_( 0 ),
