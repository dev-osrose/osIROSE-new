...
class SrvPartyReply : public CRosePacket {
    public:
        ...
        static SrvPartyReply create(const Reply&, const uint32_t&);
        static SrvPartyReply create(const uint8_t*);
        static std::unique_ptr<SrvPartyReply> allocate(const uint8_t*);
