...
const RecvPacketFactory::Initializer<uint8_t[MAX_PACKET_SIZE]> CliEquipItem::init = RecvPacketFactory::Initializer<uint8_t[MAX_PACKET_SIZE]>(ePacketType::PAKCS_EQUIP_ITEM, &createPacket<CliEquipItem>);
