...
namespace RoseCommon
{
  ...
  SrvScreenShotTimeReply::SrvScreenShotTimeReply(uint16_t year, uint8_t month, uint8_t day, uint8_t hour, uint8_t min) : CRosePacket( ePacketType::PAKSC_SCREEN_SHOT_TIME_REPLY ),
                                                                                                                         year_( year ),
                                                                                                                         month_( month ),
                                                                                                                         day_( day ),
                                                                                                                         hour_( hour ),
