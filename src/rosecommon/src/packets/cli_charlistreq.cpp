...
const RecvPacketFactory::Initializer<uint8_t[MAX_PACKET_SIZE]> CliCharListReq::init = RecvPacketFactory::Initializer<uint8_t[MAX_PACKET_SIZE]>(ePacketType::PAKCS_CHAR_LIST_REQ, &createPacket<CliCharListReq>);
